...
const KEY: &str = "yew.wave_insight.self";
...
impl Component for App {
    ...
    fn view(&self) -> Html {
        info!("rendered!");
        html! {
            <div class="wave_insight-wrapper">
                ...
                <footer class="info">
                    ...
                    <p>{ "Part of " }<a href="http://wave_insight.com/" target="_blank">{ "wave_insight" }</a></p>
                </footer>
            </div>
        }
    }
...
#[derive(EnumIter, Display, Clone, PartialEq, Serialize, Deserialize)]
pub enum Filter {
    All,
    Active,
    Completed,
